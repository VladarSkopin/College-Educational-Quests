...
import '../map_screens/map_riddles_zinger.dart';

class QuestRiddlesScreen extends StatelessWidget {
  const QuestRiddlesScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: const Text('ЗАГАДКИ ПЕТЕРБУРГА'),),
        body: Stack(
          children: [
            Container(
              decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/images/riddles.jpg'),
                      fit: BoxFit.cover
                  )
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('\nПрежде чем начать квест, убедитесь, что вы находитесь в районе Невского проспекта.\n\nИначе вам придётся очень долго добираться до первого места по квесту.',
