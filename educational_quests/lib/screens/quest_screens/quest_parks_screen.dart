...
import '../map_screens/map_parks_mars.dart';

class QuestParksScreen extends StatelessWidget {
  const QuestParksScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title: const Text('ПЕТЕРБУРГСКИЕ ПАРКИ'),),
        body: Stack(
          children: [
            Container(
              decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/images/parks.jpg'),
                      fit: BoxFit.cover
                  )
              ),
            ),
