...
class MapRiddlesHorseman extends StatefulWidget {
  const MapRiddlesHorseman({Key? key}) : super(key: key);

  @override
  State<MapRiddlesHorseman> createState() => _MapRiddlesHorsemanState();
}

class _MapRiddlesHorsemanState extends State<MapRiddlesHorseman> {
  @override
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    center: LatLng(59.936389, 30.302784),
                    zoom: 16.0,
                  ),
                  layers: [
                    TileLayerOptions(
                    ...
                    MarkerLayerOptions(
                      markers: [
                        Marker(
                          width: 80.0,
                          height: 80.0,
                          point: LatLng(59.936389, 30.302784),
                ...
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      PageTransition(
                          ...
                          child: QuizScreen(
                              questions: Question.questionsHorseman,
                              quizName: 'riddlesHorseman',
                              routeName: '/map_riddles_kunst')
                      )
                  );
                },
                child: Container(
