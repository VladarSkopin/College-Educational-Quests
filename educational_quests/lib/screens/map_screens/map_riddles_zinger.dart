...
class MapRiddlesZinger extends StatefulWidget {
  const MapRiddlesZinger({Key? key}) : super(key: key);

  @override
  State<MapRiddlesZinger> createState() => _MapRiddlesZingerState();
}

class _MapRiddlesZingerState extends State<MapRiddlesZinger> {
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    center: LatLng(59.935580, 30.325930),
                    zoom: 16.0,
                  ),
                  layers: [
                    TileLayerOptions(
                    ...
                    MarkerLayerOptions(
                      markers: [
                        Marker(
                          width: 80.0,
                          height: 80.0,
                          point: LatLng(59.935580, 30.325930),
                ...
                onTap: () {
                  ...
                  Navigator.of(context).pushReplacement(
                      PageTransition(
                          ...
                          child: QuizScreen(
                              questions: Question.questionsZinger,
                              quizName: 'riddlesZinger',
                              routeName: '/map_riddles_spas')
                      )
                  );
                },
                child: Container(
