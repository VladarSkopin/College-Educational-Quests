...
class MapParksMichael extends StatefulWidget {
  const MapParksMichael({Key? key}) : super(key: key);

  @override
  State<MapParksMichael> createState() => _MapParksMichaelState();
}

class _MapParksMichaelState extends State<MapParksMichael> {
  @override
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    center: LatLng(59.939705, 30.332617),
                    zoom: 15.0,
                  ),
                  layers: [
                    TileLayerOptions(
                    ...
                    MarkerLayerOptions(
                      markers: [
                        Marker(
                          width: 80.0,
                          height: 80.0,
                          point: LatLng(59.939705, 30.332617),
              ...
              InkWell(
                onTap: () async {
                  ...
                  await prefs.setInt('popUntil', 5);
                  await prefs.setString('lastQuiz', 'parksWasLastQuiz');
                  ...
                  Navigator.of(context).pushReplacement(
                      PageTransition(
                          ...
                          child: QuizScreen(
                              questions: Question.questionsMichaelPark,
                              quizName: 'parksMichael',
