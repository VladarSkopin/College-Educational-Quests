...
class MapCollege extends StatefulWidget {
  const MapCollege({Key? key}) : super(key: key);

  @override
  State<MapCollege> createState() => _MapCollegeState();
}

class _MapCollegeState extends State<MapCollege> {
  @override
          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                    'Подойдите как можно ближе к месту, указанному на карте и нажмите кнопку "Я на месте". \n\nВам необходимо подойти к ИСПО.',
              ...
              Container(
                ...
                child: FlutterMap(
                  options: MapOptions(
                    center: LatLng(60.003503, 30.329331),
                    zoom: 15.0,
                  ),
                  layers: [
                    TileLayerOptions(
                    ...
                    MarkerLayerOptions(
                      markers: [
                        Marker(
                            width: 80.0,
                            height: 80.0,
                            point: LatLng(60.003503, 30.329331),
              ...
              InkWell(
                onTap: () async {
                  ...
                  await prefs.setInt('popUntil', 3);
                  await prefs.setString('lastQuiz', 'collegeWasLastQuiz');
                  ...
                  Navigator.of(context).pushReplacement(
                      PageTransition(
                          ...
                          child: QuizScreen(
                              questions: Question.questionsCollege,
                              quizName: 'college',
